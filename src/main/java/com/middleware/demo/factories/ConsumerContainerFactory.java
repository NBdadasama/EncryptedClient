package com.middleware.demo.factories;
        ...
        retryTemplate.registerListener(new RetryListener() {
            ...
            public <T, E extends Throwable> void onError(RetryContext context, RetryCallback<T, E> callback, Throwable throwable) {
                if (Objects.nonNull(retryListener)) {
                    retryListener.onRetry((com.rabbitmq.client.impl.recovery.RetryContext) context, callback, throwable);
                    if (maxAttempts.equals(context.getRetryCount())) {
                        retryListener.lastRetry((com.rabbitmq.client.impl.recovery.RetryContext) context, callback, throwable);
                    }
                }
            }
        });
